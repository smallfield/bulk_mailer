...
<title>送信者の編集 | メール一括送信システム</title>
...
<body>
	<div id="header">
		<div id="menu">
			<ul>
				<li class="first current_page_item" ><a href="/editsender">送信者の編集</a></li>
						...
						<div class="entry">
							...
							<form action="commit" method="post">
								<table>
									...
									<tr>
										<td colspan="2"><input type="submit" value="登録する" />
										</td>
									</tr>
								</table>
							</form>
							<table>
								...
								<c:forEach var="e" items="${list}">
									<tr>
										<td>${f:h(e.name)}</td>
										<td>${f:h(e.email)}</td>
										<td><a href="delete?id=${f:h(e.key)}"> 削除 </a>
										</td>
									</tr>
								</c:forEach>
							</table>
